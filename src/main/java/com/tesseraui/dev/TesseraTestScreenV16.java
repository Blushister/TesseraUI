...
/**
 * Developer test screen for TesseraUI v1.6 feature: CSS {@code transition}.
 *
 * <p>Demonstrates animated hover transitions for {@code background}, {@code opacity}
 * and {@code border-color} using the {@code transition} CSS property.</p>
 *
 * <p>Open with: {@code /tessera test-v16}</p>
 */
public final class TesseraTestScreenV16 extends TesseraScreen {

    private TesseraPanel root;

    public TesseraTestScreenV16() {
        super(Component.literal("TesseraUI v1.6 — transitions"));
    }
    ...
    private void rebuild() {
        ...
        root.add(new TesseraLabel(0, 0, iW, 10,
                "TesseraUI v1.6 — transitions   (ESC pour fermer)")
                .color(TesseraPalette.COPPER_HI).fontSize(7f));

        root.add(TesseraTemplateRenderer.build(
                TesseraTemplate.load("tesseraui:ui/test_v16"),
